...
namespace Teleseto_GUI.Toggle_Btn
{
    public class ToggleButton2 : CheckBox
    {
        //Fields
        ...
        private Color backgroundcolor2 = Color.FromArgb(128, 0, 0, 255);
        //Properties
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            pevent.Graphics.FillRectangle(new SolidBrush(backgroundcolor2), -5, -5, 100, 100); // Background Size
            if (this.Checked) //ON
            {
